	                  ...
	                  <ul class="splide__list">
	                    <li class="splide__slide">
	                      <div class="child child1">
	                        <div class="text">
	                          <div class="quote">It is so easy to understand, and maneuver through. Creating templates for every type of form we need is easy, and being able to make bulk templates is a time saver. Everything is so straightforward and just makes the workflow actually flow, I feel very productive by the end of my day.</div>
	                          <div class="user-info">
	                            <div class="info">
	                              <div class="name">Nelly Moreno</div><div class="border"></div>
	                              <div class="title">Khirallah Boston PLLC</div>
	                            </div>
	                          </div>
	                        </div>
	                      </div>
	                    ...
	                    <li class="splide__slide">
	                      <div class="child child2">
	                        <div class="text">
	                          <div class="quote">I love Neos organization system. The ease of searching and locating the documents, sorting and tagging make my life so much easier. I love that you can access Neos from anywhere. No more logging into remote servers.  I also love how Neos integrates with other systems that we use, such as Outlook I was very skeptical switching from Trialworks to Neos.  I was worried about the transitions process, which ended up being painless. I never thought I would like NEOS as much as I do.</div>
	                          <div class="user-info">
	                            <div class="info">
	                              <div class="name">Kathy Ambros</div><div class="border"></div>
	                              <div class="title">Ratzen Weissman &  Boldt</div>
	                            </div>
	                          </div>
	                        </div>
	                      </div>
	                    ...
	                    <li class="splide__slide">
	                      <div class="child child3">
	                        <div class="text">
	                          <div class="quote">I love how everything is consolidated. You do not have to go 15 different places to find a document. Everything is pretty intuitive to use and search capabilities are awesome.</div>
	                          <div class="user-info">
	                            <div class="info">
	                              <div class="name">Laura Teets</div><div class="border"></div>
	                              <div class="title">Morris, King & Hodge</div>
	                            </div>
	                          </div>
	                        </div>
	                      </div>

  ...
  if (!document.querySelector("body").classList.contains("spz_5001")) {
    ...
    const bodyInterval = setInterval(function () {
      if (document.querySelector("body")) {
        ...
        // document.querySelector("body").classList.add("spz_5001");
        // document
        //   .querySelector(".spz_5001 .fixed-header")
        //   .parentElement.nextElementSibling.classList.add("section1-3001");

        //section 2
        // document
        //   .querySelector(".spz_5001 .section1-3001 ~ div:last-child")
        //   .classList.add("section6-3001");
        // document
        //   .querySelector(".spz_5001 .section1-3001 ~ div:last-child")
        //   .previousSibling.classList.add("section5-3001");
        // document
        //   .querySelector(".spz_5001 .section1-3001")
        //   .nextSibling.classList.add("section2_5001");
        // document.querySelector(".spz_5001 .section2_5001 > div > div").remove();
        document
                  ...
                  <div class="wrapper">
                    ...
                    <div class="accordion-wrapper">
                      ...
                      <div class="image">
                        ...
                        <img class="hero" data-index="5" src="//res.cloudinary.com/spiralyze/image/upload/f_auto/assembly/3001/desktop_-_accordion_images__ai_data_analysis.webp" alt="" width="632" height="464">
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="section3_5001">
            <div class="auto_container">
              <div class="section3_inner">
                ...
                <picture class="logo">
                  <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/assembly/3001/Integration-Logos-Mobile.png">
                  <source media="(max-width:1024.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/assembly/3001/Integration-Logos-tablet.png">
                  <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/assembly/3001/Integration-Logos-Desktop.png" alt="Company Logo" width="1240" height="171">
                </picture>
        ...
        loadJS(
          ...
          function () {
            var splide = new Splide(".spz_5001 .section4_5001 .splide1", {
              type: "loop",
              autoplay: true,
              arrows: true,
              autoHeight: true,

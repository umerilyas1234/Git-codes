var pricingSwiperSlideFirstDivHtml =  `
...
`;
var pricingSwiperSlideSecondDivHtml = `
...
var pricingSwiperSlideThirdDivHtml = `
    ...
    <ul class="css-ykvzw5 efpjilz7 pricing_terms">
        ...
        <li class="css-wm8ru efpjilz5">
        <div>
            <span class="css-throse efpjilz0">Marketing campaigns and lead tracking</span>
        </div>
        </li>
        <li class="css-wm8ru efpjilz5">
        <div>
            <span class="css-throse efpjilz0">In-depth reporting including lead ROI and revenue tracking</span>
        </div>
        </li>
    </ul>
`;
var featureBtnAndModal = `
    <div class="feature_btnOuter">
        <a class="feature_btn" id="feature_btn" href="javascript:void(0);">Compare All Features
    ...
    <div class="modal_inner">
        ...
        <svg id="close_modal" class="close_modal" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
            fill="none">
            <path id="svg_path" fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <ul>
                        ...
                        <div class="checklist_data">
                            ...
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
                                fill="none">
                                <path d="M3.33325 12L6.33325 9L10.3333 13L19.3333 4L22.3333 7L10.3333 19L3.33325 12Z"
                                fill="#2BC1E9"></path>
                            </svg>
                            </span>
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
                        ...
                        <li>
                        <div class="checklist_data">
                            <strong>Invoice generation, editing, and approvals</strong>
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
                                fill="none">
                                <path d="M3.33325 12L6.33325 9L10.3333 13L19.3333 4L22.3333 7L10.3333 19L3.33325 12Z"
                                fill="#2BC1E9"></path>
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-item-body-content">
                    ...
                    <ul>
                        ...
                        <li>
                        <div class="checklist_data">
                            <strong>PDF Editing, highlighting, redacting, <br />
                            and more</strong>
                            <span> </span>
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
                                fill="none">
                        ...
                        <li>
                        <div class="checklist_data">
                            <strong>Create, preview, and edit documents in <br />
                            real time
                            </strong>
                            <span> </span>
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-item-body-content">
                    ...
                    <ul>
                        ...
                        <li>
                        <div class="checklist_data">
                            <strong>Communicate with clients directly from <br />
                            case file</strong>
                            <span>
                        ...
                        <li>
                        <div class="checklist_data">
                            <strong>Internal communication with in-product <br />
                            alerts</strong>
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
                                fill="none">
                                <path d="M3.33325 12L6.33325 9L10.3333 13L19.3333 4L22.3333 7L10.3333 19L3.33325 12Z"
                        ...
                        <li>
                        <div class="checklist_data">
                            <strong>Integrated Dialer and Call Tracking <br />
                            (RingCentral)
                            <span class="tooltipstyles__TooltipStyled-sc-out8hf-0 hGHym tooltip" tabindex="0"><svg
                                width="24" height="24" role="img" accessibilitySvg="[object Object]"
                                ...
                                <span role="tooltip" id="2_5_tooltip_desc"
                                class="tooltipstyles__TooltipContainerStyled-sc-out8hf-1 borXVz">Premium features through
                                RingCentral</span></span>
                            </strong>
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
                                fill="none">
                                <path d="M3.33325 12L6.33325 9L10.3333 13L19.3333 4L22.3333 7L10.3333 19L3.33325 12Z"
                        ...
                        <div class="checklist_data">
                            ...
                            <span class="tooltipstyles__TooltipStyled-sc-out8hf-0 hGHym tooltip" tabindex="0"><svg
                                ...
                                <span role="tooltip" id="2_6_tooltip_desc"
                                class="tooltipstyles__TooltipContainerStyled-sc-out8hf-1 borXVz">Track all incoming and
                                outgoing calls</span></span>
                            </strong>
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
                                fill="none">
                                <path d="M3.33325 12L6.33325 9L10.3333 13L19.3333 4L22.3333 7L10.3333 19L3.33325 12Z"
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-item-body-content">
                    ...
                    <ul>
                        ...
                        <li>
                        <div class="checklist_data">
                            <strong>Lead ROI and revenue tracking dashboards</strong>
                            <span> </span>
                            <span> </span>
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
                                fill="none">
                        ...
                        <li>
                        <div class="checklist_data">
                            <strong>Dynamic Intake Forms with Required <br />
                            Questions
                            </strong>
                            <span> </span>
                            <span> </span>
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-item-body-content">
                    ...
                    <ul>
                        <li>
                        <div class="checklist_data">
                            <strong>US-based weekday phone support <br />
...
var featuresSectionHtml = `
    <section class="section2_5001" data-testid="component-wrapper__container">
...
var integrationsSectionHtml = `
    <section class="section3_5001" data-testid="component-wrapper__container">
        <div class="auto_container">
...
var whyCustomerLoveSectionHtml = `
    <section class="section4_5001" data-testid="component-wrapper__container">
...
var faqAccordionContent3Html = `<p>Our dedicated migration and onboarding team can help you get set up and running in as little as 1 week.</p>`;
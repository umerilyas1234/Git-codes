  (function() {
    const bodyInterval2001 = setInterval(function(){
      if(document.querySelector('body') && !document.querySelector('.spz_2001_v')){
        clearInterval(bodyInterval2001)
        let formInterval;
        document.querySelector('body').classList.add("spz_2001_v","spz_2001_v1")
        document.querySelector('.spz_2001_v header').insertAdjacentHTML("afterend",`
          <div class="spz-2001-section1">
            <div class="wrapper">
              <div class="header">
              <a href="https://www.lendio.com/lp/direct/sbf">
                <picture>
                  <source media="(max-width:767.98px)" srcset="https://res.cloudinary.com/spiralyze/image/upload/v1763371538/lendio/2001/Lendio-logomobile.svg">
                  <img src="https://res.cloudinary.com/spiralyze/image/upload/v1763371538/lendio/2001/Lendio-logodesktop.svg" width="127" height="24" alt="Lendio Logo">
                </picture>
              </a>
              </div>
              <div class="hero-section">
                <div class="text">
                  <div class="eyelash">SBA SMALL BUSINESS FUNDING</div>
                  <div class="title">Check eligibility & <spa class="green"n>view offers in minutes.</span></div>
                  <div class="trustpilot">
                    <img src="https://res.cloudinary.com/spiralyze/image/upload/v1763373686/lendio/2001/trustpilot-black.svg" alt="Trustpilot Logo" width="104" height="26">
                    <img src="https://res.cloudinary.com/spiralyze/image/upload/v1763373686/lendio/2001/stars.svg" alt="Stars Logo" width="98" height="18">
                    <div class="text"><strong>4.6</strong>(21,665 reviews)</div>
                  </div>
                  <ul>
                    <li><strong>Fast application.</strong> Apply for business funding in minutes. No effect on your credit. Get funds as soon as next day.</li>
                    <li><strong>75+ Lenders.</strong> See offers from over 75 vetted lenders. Get the best interest rates, APR, terms, etc.</li>
                    <li><strong>Loan options.</strong> Loan types include accounts receivable, equipment financing, SBA and small business.</li>
                  </ul>
                </div>
                <div class="form"></div>
              </div>
        ...
        window.dispatchEvent(new Event('resize'));
         //form
        document.querySelector('.spz-2001-section1 .hero-section .form').insertAdjacentElement("afterbegin",document.querySelector('.application-form-wrap-lp-spec')) ;

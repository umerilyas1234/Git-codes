  ...
  if (!document.querySelector('body').classList.contains('spz_3003') && document.querySelector('#sg-popup-content-wrapper-6993 .sgpb-main-html-content-wrapper')) {
    ...
    if (location.origin === 'https://canoeintelligence.com' &&
      ...
      document.querySelector('.heroContent').insertAdjacentHTML('afterbegin', `<div class="heroLeft">
          ...
          <ul>
              <li><strong>Document management.</strong> Automatically retrieve post-investment docs from email inboxes & 3000+ GP portals. Automatically categorize & store in one place. </li>
              <li><strong>Data extraction.</strong> Instantly extract & normalize key data points with a 99% accuracy rate. Expedite workflows across cap calls, distributions, fund metrics, and more with AI.</li>

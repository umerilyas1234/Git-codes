...
const US = `<img src="${imgPath}/image_422.webp" alt="Ace Hardware" />
            <img src="${imgPath}/image_417.webp" alt=" Dutchbros" />
            <img src="${imgPath}/image_419.webp" alt="Harper Logistics" />
            <img src="${imgPath}/image_418.webp" alt="Healthcare Reliant" />
            <img src="${imgPath}/image_420.webp" alt="F45" />
            <img src="${imgPath}/image_421.webp" alt="Mercy Urgent Care" />`,
...
function loadTestCode6001() {
  if (!document.querySelector("#main-container").classList.contains("spz_6001")) {
            ...
            <ul>
                <li>
                    <div class="reviews_main">
                        <figure>
                            <img src="https://res.cloudinary.com/spiralyze/image/upload/v1716893790/deputy/6001/capterra.svg" alt="Capterra">
                        </figure>
                    </div>
                </li>
                <li>
                    <div class="reviews_main">
                        <figure>
                            <img src="https://res.cloudinary.com/spiralyze/image/upload/v1716893791/deputy/6001/app_store.svg" alt="App Store">
                        </figure>
                    </div>
                </li>
                <li>
                    <div class="reviews_main">
                        <figure>
                            <img src="https://res.cloudinary.com/spiralyze/image/upload/v1716893790/deputy/6001/google_play.svg" alt="Google Play">
                        </figure>
                    </div>
                </li>
            </ul>
    ...
    `);
    var socialLoginFacebook = document.querySelector('.spz_hero #g-header-media-ctas-form-facebook-login');
    var socialLoginGoogle = document.querySelector('.spz_hero #g-header-media-ctas-form-google-login');

    if (socialLoginFacebook && socialLoginGoogle) {
        socialLoginFacebook.insertAdjacentElement('afterend', socialLoginGoogle);
    }

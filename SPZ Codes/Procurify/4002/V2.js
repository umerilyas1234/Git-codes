...
function loadTestCode() {
  if (!document.querySelector("body").classList.contains("spz_4002")) {
        ...
        <div class="auto_container">
            <div class="integrations_inner">
                ...
                <div class="integration_right">
                    <picture>
                        <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/procurify/4002/ui_v2_360.webp">
                        <source media="(max-width:1024.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/procurify/4002/ui_v2_big.webp">
                        <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/procurify/4002/ui_v2_big.webp" alt="procurify_integrations_ERPs_and_finance" width="1240" height="171" loading="lazy">
                    </picture>
                </div>
            </div>
        </div>
    ...
    hiddenValue('#5004 | Procurify | PDPs | Email + CTA + Social Proof', '4002_Variant_2');
  }
}

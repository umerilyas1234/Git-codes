...
function loadTestCode5003() {
  if (!document.querySelector("body").classList.contains("spz_t5003")) {
    ...
    const stickyFooterContent = {
        sectionLeftHTML: `
          <p>Take control of spend with procure-to-pay software</p>
        `,
        sectionMiddleHTML: `
    ...
    ************************/
    ...
    function hideShowStickyBar() {
      if (window.scrollY > scrollPosition) {
        document.querySelector("body").classList.add("goUp", "v1");
      } else {
        document.querySelector("body").classList.remove("goUp", "v1");
      }
    }
    ...
    hiddenValue('#5003 | Procurify | PDPs | Sticky CTA', '5003_Control');

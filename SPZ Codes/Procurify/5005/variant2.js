...
function loadTestCode5005() {
  if (!document.querySelector("body").classList.contains("spz_t5005")) {
    ...
    var modalHtml = `<div class="modal_form_wrapper v2">
                <div class="modal_form">
                  <a href="javascript:void(0);" class="close_modal">
                    <img src="//res.cloudinary.com/spiralyze/image/upload/v1722433144/procurify/5005/wrapper.svg" alt="close icon">
                  </a>
                  ...
                  <div class="section3">
                    <div class="text">Helping global customers save millions on procurement</div>
                    <picture>
                      <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/v1722433131/procurify/5005/logos_360.svg">
                      <source media="(max-width:1023.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/v1722433131/procurify/5005/logos_768.svg">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/procurify/4001/Logos-desktop.png" alt="Logos" width="2528" height="96">
                    </picture>
                  </div>
                </div>
               </div>
    ...
    const formInterval = setInterval(function () {
      if (typeof MktoForms2 !== 'undefined') {
        ...
        MktoForms2.whenReady(function (form) {
          ...
          jQuery('.modal_form_wrapper').addClass('collapsed');
              ...
              if (jQuery(this).attr('id') == 'Email' && jQuery(this).hasClass('mktoValid')) {
                setTimeout(() => {
                  ...
                  if (emailPattern.test(email)) {
                    ...
                    jQuery('.modal_form_wrapper').removeClass('collapsed');
                  }
                }, 500);
              }
    ...
    hiddenValue('#5005', '5005_Variant_2');

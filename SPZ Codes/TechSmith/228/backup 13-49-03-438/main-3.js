    ...
    insertProducts('.SubscriptionPlan2', `
      <div class="my_products">
        ...
        <ul>
          ...
          <li>
            <div class="product_data">
              <img src="//res.cloudinary.com/spiralyze/image/upload/v1737506601/techsmithcamtasia/221/speech_to_tx_logo_3.svg" alt="Audiate">
              <strong>Audiate</strong>
            </div>
          </li>
        </ul>
      </div>
    ...
    insertProducts('.SubscriptionPlan3', `
      <div class="my_products">
        ...
        <ul>
          ...
          <li>
            <div class="product_data">
              <img src="//res.cloudinary.com/spiralyze/image/upload/v1737506609/techsmithcamtasia/221/video_hosting_2.svg" alt="Screencast">

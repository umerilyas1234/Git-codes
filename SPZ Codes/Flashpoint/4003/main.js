  ...
  `;
    var bannerInterval = setInterval(() => {
      if (document.querySelectorAll(".right").length > 0) {
        ...
        console.log("222");
        document
          .querySelector(".table-of-contents .right>p:nth-of-type(4)")
          .previousElementSibling.insertAdjacentHTML("beforebegin", newHtml);
        document
          .querySelector(".table-of-contents .right>p:nth-of-type(11)")

function loadTestCode8003b() {
  if (!document.querySelector("body").classList.contains("spz_8003")) {
    ...
    const modalData = {
      ...
      modalContent: '<ul><li><strong>Lease Accounting.</strong> Auto-generate error-free amortization schedules, journal entries, and disclosure reports.</li><li><strong> Compliance.</strong> CPA-approved solution for compliance with ASC 842, GASB 87 and 96, IFRS 16, and SFFAS 54. </li><li><strong>Lease Tracking. </strong>  Store leases in a central repository, receive automated alerts, and monitor your portfolio from one dashboard.</li></ul>',
    ...
    ************************/
    ...
    function addModal(modalData, modalDelay, leavePage, timesToAppear) {
      const modalTemplate = `
        <div class="spz-modal-wrap leases">

function loadTestCode8003a() {
  if (!document.querySelector("body").classList.contains("spz_8003")) {
    ...
    const modalData = {
      modalHeading: 'One <strong>platform</strong>  for your <br> largest areas of <strong>spend</strong>.',
      modalContent: '<ul><li><strong>Lease Accounting & Management.</strong>  Track your leases and easily comply with ASC 842, IFRS 16, SFFAS 54, and GASB 87 and 96.</li><li><strong>Software Asset Management.</strong>  Automated SaaS discovery and license management. Manage onboarding. Reduce costs.</li><li><strong>Contract Management. </strong>  Get full visibility across contracts. Track renewals and payments. Simplify budgeting and forecasting.</li></ul>',
    ...
    ************************/
    ...
    function addModal(modalData, modalDelay, leavePage, timesToAppear) {
      const modalTemplate = `
        <div class="spz-modal-wrap generic">

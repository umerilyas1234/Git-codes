  ...
  if (document.querySelector('body') && !document.querySelector('.spz_6002')) {
    ...
    document.querySelector('.spz_6002 #formjumplink').insertAdjacentHTML("afterend", `
        ...
        <div class="new-hero-section-wrapper">
          <div class="left">
            ...
            <div class="review-star">
              ...
              <div class="text"><strong>4.4</strong> (2,521 reviews)</div>
            </div>
      ...
      <div class="slider-wrapper-4002">
        <div class="slider-title">1,000+ integrations to connect with the tools you use daily</div>
    ...
    const formLoaded = setInterval(() => {
      if (document.querySelector(formUniqueSelector) && document.querySelectorAll(`${formUniqueSelector} input`).length > 0) {
        ...
        `)
        for (let i = 0; i < document.querySelectorAll('.spz_6002 #signupType .form-option-field span').length; i++) {
          document.querySelector('.spz_6002 #businessType').insertAdjacentHTML("beforeend", `
            <option value="${document.querySelectorAll('.spz_6002 #signupType .form-option-field')[i].querySelector('span').textContent}" >${document.querySelectorAll('.spz_6002 #signupType .form-option-field')[i].querySelector('span').textContent}</option>  
          `)
        }
        document.querySelector('.spz_6002 #businessType').addEventListener("change", function () {
          document.querySelectorAll('.spz_6002 #signupType .form-option-field')[document.querySelector('.spz_6002 #businessType').selectedIndex].querySelector('input').click()
        })
        //disclaimer 

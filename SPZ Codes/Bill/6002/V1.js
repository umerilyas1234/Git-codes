// localStorage.setItem('bdcAbTest12','6003-con');
      ...
      <section class="splide splide4002">
          ...
          <ul class="splide__list">
              ...
              <div class="img-wrapper">
                  ...
                  <picture>
                  <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/v1738852145/bill/6002/logo-xero.svg">
                  <img src="//res.cloudinary.com/spiralyze/image/upload/v1738852145/bill/6002/logo-xero.svg" alt="Xero Logo" width="50" height="56"/>
                  </picture>
              </div>
              </li>
              <li class="splide__slide">

const bodyInterval4006 = setInterval(function () {
  if (document.querySelector('body') && !document.querySelector('.spz-4006')) {
    ...
    document.querySelector('body').classList.add("spz-4006", "v2")
    localStorage.setItem('bdcAbTest11', '4006-v2');
    ...
    ************************/
    ...
    var sectionSelector;
    if (window.location.href.includes("lp/ach")) {
      sectionSelector = document.querySelector('.background-color-light-blue')
    } else if (window.location.href.includes("/lp/invoices")) {
      sectionSelector = document.querySelector('.spz-4006 > div:nth-of-type(6)')
    } else if (window.location.href.includes("/lp/bill-pay")) {
      sectionSelector = document.querySelector('.spz-4006 > section:nth-of-type(3)')
    }
    if (sectionSelector) {
                ...
                <ul>
                  <li>
                    <div class="why_usData">
                      ...
                      <small>
                        <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/bill/4006/avatar-lee-ann-mills_1.webp" alt="Lee Ann Mills">
                        <strong>
                          Lee Ann Mills, CFO
                  ...
                  <li>
                    <div class="why_usData">
                      ...
                      <small>
                        <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/bill/4006/avatar-jim-lower_1.webp" alt="Jim Lower">
                        <strong>
                  ...
                  <li>
                    <div class="why_usData">
                      ...
                      <small>
                        <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/bill/4006/avatar-amy-liu_1.webp" alt="Amy Liu">
                        <strong>
                          Amy Liu, Founder & CEO
                          <b>Tower 28 Beauty</b>
                        </strong>

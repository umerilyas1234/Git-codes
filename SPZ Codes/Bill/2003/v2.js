function loadTestCode() {
    if (!document.querySelector('body').classList.contains('spz_t2003')) {
        document.querySelector('body').classList.add('spz_t2003', "v2");
        ...
        document.querySelector('.card-container').insertAdjacentElement('beforebegin', document.querySelector('.card-container  + .align-center-mobile'));
    }
}

const bodyInterval7004 = setInterval(function () {
  if (document.querySelector('body') && !document.querySelector('.spz_7004')) {
    ...
    if (window.location.href.includes("/product/credit")) {
      ...
      document.querySelector('.new-hero-section-wrapper .left').insertAdjacentElement('afterbegin', document.querySelector('#formjumplink .container-large .text-size-medium'));
      document.querySelector('.new-hero-section-wrapper .left').insertAdjacentElement('afterbegin', document.querySelector('#formjumplink .container-large h1'));
      document.querySelector('.new-hero-section-wrapper .left').insertAdjacentElement('afterbegin', document.querySelector('#formjumplink .container-large .eyebrow'));
      ...
      document.querySelector('.new-hero-section-wrapper .left').insertAdjacentElement('afterbegin', document.querySelector('#formjumplink .container-large .text-size-tiny'));
      document.querySelector('.new-hero-section-wrapper .left').insertAdjacentElement('afterbegin', document.querySelector('#formjumplink .container-large .text-size-large'));
      document.querySelector('.new-hero-section-wrapper .left').insertAdjacentElement('afterbegin', document.querySelector('#formjumplink .container-large h1'));
      document.querySelector('.new-hero-section-wrapper .left').insertAdjacentElement('afterbegin', document.querySelector('#formjumplink .container-large .eyebrow'));
      document.querySelector('.new-hero-section-wrapper .right').innerHTML = `
        <picture>

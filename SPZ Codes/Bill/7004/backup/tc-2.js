    ...
    if (!document.querySelector('body').classList.contains('spz_t7001')) {
      ...
      function labelChange(e) {
        if (e.value == '' || e.value == null) {
          if (e.closest(".form-field-wrap").classList.contains("hasValue")) {
      ...
      if (document.querySelector('#se-form-button')) {
        document.querySelector('#se-form-button').classList.add('spz-submitcta-1002', 'spz_7004_tc');
      ...
      if (document.querySelector('#email').value !== '') {
        trigger(document.querySelector('#email'), 'keyup')
      }
    }
  }

const bodyInterval1002 = setInterval(function () {
  if (document.querySelector('body') && !document.querySelector('.spz-1002')) {
    ...
    localStorage.setItem('bdcAbTest12', '1012-con');
    ...
    const formLoaded = setInterval(() => {
      if (document.querySelector(formUniqueSelector) && document.querySelectorAll(`${formUniqueSelector} input`).length > 0) {
        ...
        //submit button 
        document.querySelector('.spz-1002 .submit-button.button-signup-2').classList.add("spz_1012_tc")
        document.querySelector('.spz-1002 .submit-button.button-signup-2').disabled = false
        /*
        //disclaimer 

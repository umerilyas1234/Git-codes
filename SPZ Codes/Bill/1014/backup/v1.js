...
const bodyInterval1002 = setInterval(function () {
  ...
  const formLoaded = setInterval(() => {
      ...
      // change position
      document.querySelector('.spz-1014 .spz-input-wrapper.email').insertAdjacentElement('afterend', document.querySelector('.spz-1014 .spz-input-wrapper.name'))
      ...
      document.querySelector('.spz-1014 .spz-input-wrapper.signupType-wrapper ').append(document.querySelector('.spz-1014 #signupType').closest('#form-panel-3'));

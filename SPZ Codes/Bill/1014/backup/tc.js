const bodyInterval1002 = setInterval(function () {
  ...
  localStorage.setItem('bdcAbTest12', '1014-con');
  ...
  const formLoaded = setInterval(() => {
      ...
      document.querySelector('.spz-1012 .spz-input-wrapper.numberOfEmployees ').insertAdjacentHTML("beforebegin", `
          <div class="spz-input-wrapper signupType-wrapper"></div>`);

      document.querySelector('.spz-1012 .spz-input-wrapper.signupType-wrapper ').append(document.querySelector('.spz-1012 #signupType').closest('#form-panel-3'));
      ...
      //submit button 
      document.querySelector('.spz-1012 .submit-button.button-signup-2').classList.add("spz_1012_tc")
      document.querySelector('.spz-1012 .submit-button.button-signup-2').disabled = false

      // existiing account
      document.querySelector('.spz-1012 .button-disclaimer').insertAdjacentHTML("afterend", `<div class="existiing_account">Already have an account? <a href="https://login.us.bill.com/neo/login" class="spz_1012_tc">Login</a></div>`);

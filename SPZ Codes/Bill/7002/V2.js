if (window.location.href.includes("product/credit")) {
  const bodyInterval7002 = setInterval(function () {
    if (document.querySelector('body') && !document.querySelector('.spz_7002')) {
      ...
      localStorage.setItem('bdcAbTest15', '7002-V2');
      ...
      ************************/
      ...
      document.addEventListener("keydown", function (e) {
        if (e.key === "Enter" && e.target.classList.contains("spz-primary")) {
          submitForm(e);
        }
      });
      ...
      function submitForm(e) {
        ...
        var inputValue = document.querySelector('.spz-ctas-wrap input').value;
        document.querySelector('#email').value = inputValue;
      }
        ...
        <div class="spz-sticky-footer v2">
          <div class="spz-footer-container">
            ...
            <div class="spz-ctas-wrap">
              ...
              ${stickyFooterContent.CTAs.map((item) => `<a href=${item.ctaURL} class="spz_7002_v2 spz-primary">${item.ctaText}</a>`).join("")}
            </div>
          </div>

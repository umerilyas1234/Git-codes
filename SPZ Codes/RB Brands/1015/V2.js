function loadTestCode() {
  if (!document.querySelector('body').classList.contains('spz_t1015')) {
      ...
      document.querySelector('body').classList.add('t1015_v2');
      ...
      document.querySelector('.spz_t1015 #scroll').insertAdjacentHTML('beforeend',`<div class="spz-footer-container">
          ...
          <div class="spz-ctas-wrap">
              <a href="tel:${getNumber}" aria-label="${getNumber}" class="font-bold sm:text-base text-xs text-white leading-[22px] bg-primary rounded-lg py-[13px] sm:py-4 ps-3 sm:ps-[33px] pr-2 sm:pr-[30px] flex items-center sm:ms-5 transition-all ease-in-out duration-150 hover:scale-95 btn1 spz_1015_v2"><span><img src="//appliancerepairtoday.net/wp-content/themes/appliancerepairtoday/theme/assets/images/svg/tel-icon.svg" alt="mobile-icon" loading="lazy"></span>${getNumber}</a>
              <a href="tel:${getNumber}" aria-label="${getNumber}" class="font-bold sm:text-base text-xs text-white leading-[22px] bg-primary rounded-lg py-[13px] sm:py-4 ps-3 sm:ps-[33px] pr-2 sm:pr-[30px] flex items-center sm:ms-5 transition-all ease-in-out duration-150 hover:scale-95 btn2 spz_1015_v2"><span><img src="//appliancerepairtoday.net/wp-content/themes/appliancerepairtoday/theme/assets/images/svg/tel-icon.svg" alt="mobile-icon" loading="lazy"></span> Phone Consultation </a>
          </div>
      </div>`);
  }
}

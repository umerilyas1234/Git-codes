function loadTestCode1013() {
  if (!document.querySelector("body").classList.contains("spz_t1013")) {
    ...
    const linkElement = document.querySelector('.spz_t1013 .hero_sec > div > div > a');
    ...
    document.querySelector('.hero_sec > div > div > a[aria-label="Get Help Now"]').innerHTML = `<img src="//res.cloudinary.com/spiralyze/image/upload/v1725008061/rbbrands/1013/icon-phone.svg" alt="Phone"> ${phoneNumber}`;

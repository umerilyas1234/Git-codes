function loadTestCode5014() {
    if (!document.querySelector("body").classList.contains("spz_t5014")) {
        document.querySelector("body").classList.add("spz_t5014");
        const linkElement = document.querySelector('.home > div:nth-of-type(1) > div:nth-of-type(2) > a');

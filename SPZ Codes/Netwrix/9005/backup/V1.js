  ...
  if (!document.querySelector("body").classList.contains("spz_9005_v1")) {
    ...
    setTimeout(() => {
      ...
      if (window.location.href.includes("product_online_demo.html")) {
        ...
        <ul>
          <li>
            <p><strong>No Installation.</strong> Launch instantly. Explore features, configure alerts, and setup mitigation actions all from your browser.</p>
          </li>
          <li>
      ...
      `
        ...
        <h2>Get hands on with next-gen access management</h2>
        <ul>
          <li>
            <p><strong>Instant Access.</strong>  Launch in your browser. Test features, locate sensitive data, and automate DSAR fulfillment. No installation.</p>
          </li>
          <li>
            <p><strong>Access Control.</strong> Spot risky permissions and adjust. Auto-block shadow users. Delegate access reviews to resource owners.</p>
          </li>
          <li>
            <p><strong>Reporting.</strong> Generate risk reports. Includes file share summaries, vulnerability overviews, user activity logs, and more.</p>
          </li>
        </ul>
      `
        ...
        <ul>
          <li>
            <p><strong>No Installation.</strong> Launch instantly. Explore features, configure password rules, and set up alerts for compromised credentials.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Enforcement.</strong> Apply rules per user and role. Enforce Windows GPO and FGPP. Automate resets with guided password creation.</p>
          </li>
        </ul>
      `
      }

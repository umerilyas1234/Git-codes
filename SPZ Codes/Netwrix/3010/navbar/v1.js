const bodyInterval3010navbar = setInterval(function () {
	if (document.querySelector('body') && !document.querySelector('.spz_3010_navbar')) {
		...
		document.querySelector('.navbar-start>a[href="how_to_buy.html"]').insertAdjacentHTML('afterend', `
				...
				<ul class="navbar-dropdown">
					<li class="navbar-item">
						<a class="nav-link" href="/how_to_buy.html">
							<img src="//res.cloudinary.com/spiralyze/image/upload/v1747232844/netwrix/3010/icon-request-pricing.svg" alt="request pricing icon">
							Request Pricing
						</a>
					</li>
					<li class="navbar-item">
						<a class="nav-link" href="/netwrix-pricing.html">
							<img src="//res.cloudinary.com/spiralyze/image/upload/v1747232843/netwrix/3010/icon-buy-now.svg" alt="request pricing icon">
							Buy Now
						</a>
					</li>
				</ul>
			...
			`);
			document.querySelector('.new_pricing').insertAdjacentElement('afterbegin', document.querySelector('.navbar-start>a[href="how_to_buy.html"]'));

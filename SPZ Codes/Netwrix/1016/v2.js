function runCode() {
  if (!document.body.classList.contains('spz_1016')) {
    ...
    document.querySelector('header .navbar-end .contact-item').insertAdjacentHTML('afterbegin', `<a href="https://www.netwrix.com/one-to-one.html" class="getDemo_cta v2 spz_1016_v2">Get a Free Trial</a>`)

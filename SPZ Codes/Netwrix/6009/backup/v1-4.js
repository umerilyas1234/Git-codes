function runCode() {
  if (!document.body.classList.contains('spz-6009')) {
    ...
    formContainer.querySelector(`.modelFormSubmit`).insertAdjacentHTML('afterend', `<button class="btn btn_filled_red btn-red-fill modelFormSubmit spz_formSubmit">Download Free Trial</button>`);
    ...
    document.addEventListener('click', function (e) {
      ...
      if (e.target.classList.contains('spz_formSubmit')) {
        formContainer.querySelector(`.modelFormSubmit`).click();
      }
    });
    ...
    function runInterval() {
      ...
      let formInterval = setInterval(() => {
        console.log('adsadasdsadsadas',formContainer.querySelector(`.modelFormSubmit`));
        if (formContainer.querySelector(`.modelFormSubmit`)) {

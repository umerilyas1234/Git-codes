function runCode() {
  if (!document.body.classList.contains('spz-6009')) {
              ...
              <div class="hero-container">
                  <div class="hero-flex">
                      ...
                      <div class="hero-image-contain">
                          <picture>
                              <source media="(max-width:991.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/6001/frame_1171276197.webp">
                              <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/6001/frame_1171276196.webp" alt="auditor_ui_image">
                          </picture>	
                      </div>
                  </div>
              </div>
    ...
    if (document.querySelector('.hero-buttons .buttons-cont .button-section:nth-child(2) .one-field-form-button-test .form-widget-full .get-demo')) {
      document.querySelector('.hero-buttons .buttons-cont .button-section:nth-child(2) .one-field-form-button-test .form-widget-full .get-demo').addEventListener('click', function () {
        updateFormAndButton(containerIndex);
      });
    }
    ...
    function updateFormAndButton(containerIndex) {
      const formTitle = document.querySelector(`.spz-6009> div:nth-of-type(${containerIndex}) .form-title`);
      const leadTypeInput = document.querySelector(`.spz-6009> div:nth-of-type(${containerIndex}) #ModalForm_leadType`);
      const submitButton = document.querySelector(`.spz-6009> div:nth-of-type(${containerIndex}) .modelFormSubmit`);
      const formField = document.querySelector(`.spz-6009 > div:nth-of-type(${containerIndex}) form #SPZ_Test`);
      formTitle.textContent = "Start using Netwrix Auditor";
      leadTypeInput.value = "Evaluation";
      submitButton.value = 'Download Free Trial';
      formField.value = 'variant1_6009';
    }

    const containerIndex = document.querySelector('.cookie-information-cont') ? 7 : 6;

    setTimeout(() => {
      updateFormAndButton(containerIndex);

      const targetNode = document.querySelector(`.spz-6009 > div:nth-of-type(${containerIndex}) form .modelFormSubmit`);

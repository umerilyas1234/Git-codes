function runCode() {
  if (!document.body.classList.contains('spz-6009')) {
    ...
    document.querySelectorAll('.spz-6009 .head-cont .nwx-btn').forEach((item) => {
      item.classList.add('spz_6009_v2');
    });

    document.querySelectorAll('.spz-6009 .head-cont button.nwx-btn').forEach((item) => {
    ...
    var button = document.querySelector(".head-cont .buttons-cont .button-section:first-child > [id^='app-']");
    ...
    function updateFormAndButton() {
      ...
      if(document.querySelector(`.spz_modal form #SPZ_Test`)){
        document.querySelector(`.spz_modal form #SPZ_Test`).value = 'variant2_6009';
      }

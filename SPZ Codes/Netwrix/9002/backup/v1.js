    ...
    setTimeout(() => {
      ...
      ************************/
      ...
      const callback = (mutationList, observer) => {
        ...
        //button
        if (document.querySelector('.form-horizontal input[type="submit"]').value == "Launch In-Browser Tour") {
          document.querySelector('.form-horizontal input[type="submit"]').classList.add('spz2002-cta-submit');
          document.querySelector('.form-horizontal input[type="submit"]').value = "Instant Access";
        }

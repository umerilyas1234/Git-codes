function loadTestCode9001() {
  if (!document.querySelector("body").classList.contains("spz_t9002")) {
    document.querySelector("body").classList.add("spz_t9002");
    setTimeout(() => {
      if (document.querySelector(".welcome-screen")) {
        document.querySelector('.welcome-screen').insertAdjacentHTML('beforeend', `
      ...
      if (window.location.href.includes("product_online_demo.html")) {
        ...
        if (document.querySelector("#video_play")) {
          document.querySelector("#video_play").src = "//res.cloudinary.com/spiralyze/video/upload/v1741944827/netwrix/9002/vid/9002_In-Browser_Demo.mp4";
        }
        ...
        formTitle = "Netwrix Data Classification <br>";
        if (document.querySelector("#video_play")) {
          document.querySelector("#video_play").src = "//res.cloudinary.com/spiralyze/video/upload/v1741944827/netwrix/9002/vid/Data_Classification.mp4";
        }
        ...
        if (document.querySelector("#video_play")) {
          document.querySelector("#video_play").src = "//res.cloudinary.com/spiralyze/video/upload/v1741944827/netwrix/9002/vid/Usercube.mp4";
        }
        ...
        if (document.querySelector("#video_play")) {
          document.querySelector("#video_play").src = "//res.cloudinary.com/spiralyze/video/upload/v1741944827/netwrix/9002/vid/Enterpise_Auditor.mp4";
        }
        ...
        if (document.querySelector("#video_play")) {
          document.querySelector("#video_play").src = "//res.cloudinary.com/spiralyze/video/upload/v1741944827/netwrix/9002/vid/Password_Policy_Enforcer.mp4";
        }
        if (!document.querySelector(".welcome-screen #video_play")) {
          setTimeout(() => {
            if (document.querySelector(".welcome-screen")) {
              document.querySelector('.welcome-screen').insertAdjacentHTML('beforeend', `
                <video autoplay muted loop playsinline id="video_play">
                  <source src="//res.cloudinary.com/spiralyze/video/upload/v1741944827/netwrix/9002/vid/Password_Policy_Enforcer.mp4" type="video/mp4">
                </video>
                `);
            }
          }, 500);
      ...
      ************************/
      ...
      setTimeout(() => {
        ...
        if (document.querySelector(".spz-form-wrap #ModalForm_nwf_nsrv")) {
          document.querySelector(".spz-form-wrap #ModalForm_nwf_nsrv").options[0].text = "# of Employees";
        }
      ...
      const callback = (mutationList, observer) => {
        ...
        document.querySelectorAll('.form_outer .error-summary').forEach(element => {
          if (element.textContent.includes("Direct Phone")) {
            element.textContent = element.textContent.replace("Direct Phone", "Phone");
          }
        });

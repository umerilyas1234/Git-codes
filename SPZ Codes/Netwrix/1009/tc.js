    ...
    const run1008Test = () => {
      ...
      for (let i = 0; i < document.querySelectorAll('[action="/contact.html"]').length; i++) {
        ...
        if (formParent.querySelector('#SPZ_Test').value == "") {
          formParent.querySelector('#SPZ_Test').value = "control_1009"
        } else {
          formParent.querySelector('#SPZ_Test').value = formParent.querySelector('#SPZ_Test').value + ",control_1009";
        }
        ...
        function updatedText() {
          const errMsg = document.querySelector('.popup-wrapper-1008 form .modelFormError');
          if (errMsg) {
            let html = errMsg.innerHTML;
  
            if (html.includes('Direct Phone cannot be blank.')) {
              errMsg.closest('.popup-wrapper-1008 form .modelFormError').classList.add('er_1');
              errMsg.closest('.popup-wrapper-1008 form .modelFormError').classList.remove('er_2', 'er_3', 'er_4');
            }  else if (html.includes('Email cannot be blank')) {
              errMsg.closest('.popup-wrapper-1008 form .modelFormError').classList.add('er_2');
              errMsg.closest('.popup-wrapper-1008 form .modelFormError').classList.remove('er_1', 'er_3', 'er_4');
            } else if (html.includes('e-mail')) {
              errMsg.closest('.popup-wrapper-1008 form .modelFormError').classList.add('er_3');
              errMsg.closest('.popup-wrapper-1008 form .modelFormError').classList.remove('er_1', 'er_2', 'er_4');
            } else if (html.includes('Please enter a valid Direct Phone.')) {
              errMsg.closest('.popup-wrapper-1008 form .modelFormError').classList.add('er_4');
              errMsg.closest('.popup-wrapper-1008 form .modelFormError').classList.remove('er_1', 'er_3', 'er_2');
            } else {
              errMsg.closest('.popup-wrapper-1008 form .modelFormError').classList.remove('er_1', 'er_2', 'er_3', 'er_4');
            }
          }
        }

    ...
    setTimeout(() => {
      ...
      ************************/
      ...
      setTimeout(() => {
        ...
        reviewSlider();
        document.querySelector(".spz_form #ModalForm_account_type").options[0].text = "Organization Type";
        document.querySelector(".spz_form #ModalForm_nwf_nsrv").options[0].text = "# of Employees";

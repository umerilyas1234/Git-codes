...
function loadTestCode2005() {
  if (!document.querySelector("body").classList.contains("spz_t2010")) {
    document.querySelector("body").classList.add("spz_t2010", "spz_t2006");
    setTimeout(() => {
      ...
      ************************/
          ...
          <div class="form_main">
            <div class="spz-form-wrap">
                <div class="qlf-form">
                    ...
                    <div class="qlf-cta SPZ_QualifyingQuestionsCTA spz_2010_v1">Next</div>
                </div>
                <div class="step_2">
                  <div class="left">
      ...
      const callback = (mutationList, observer) => {
        ...
        if (document.querySelector('.spz_form .btn-red-fill').value == "Schedule Demo") {
          document.querySelector('.spz_form .btn-red-fill').classList.add('spz_2010_v1');

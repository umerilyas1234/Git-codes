...
function loadTestCode2006() {
  if (!document.querySelector("body").classList.contains("spz_t2010")) {
    ...
    setTimeout(() => {
      ...
      document.querySelector(`.spz_t2010 > div:nth-of-type(${containerIndex}) form`).classList.add("spz_form");
      ...
      ************************/
      ...
      const callback = (mutationList, observer) => {
        ...
        if (document.querySelector('.spz_form .btn-red-fill').value == "Schedule Demo") {
          document.querySelector('.spz_form .btn-red-fill').classList.add('spz2010-cta-submit');

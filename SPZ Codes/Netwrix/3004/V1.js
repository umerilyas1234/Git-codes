		...
		************************/
										...
										<div class="child first-child">
											<span class="sliderNav desktopOnly">
												<strong><i><img
															...
															alt="Data"></i>Data Security</strong>
												<b>Discovery, classification, access, loss prevention</b>
											</span>
										</div>
									</li>
									<li class="splide__slide">
										<div class="child">
											<span class="sliderNav desktopOnly">
												<strong><i><img
															...
															alt="Identity Security"></i>Identity Security</strong>
												<b>PAM, IGA, Active Directory and password security</b>
											</span>
										</div>
									</li>
									<li class="splide__slide">
										<div class="child">
											<span class="sliderNav desktopOnly">
												<strong><i><img
															...
															alt="Endpoint Security"></i>Endpoint Security</strong>
												<b>Management, configuration, device control</b>
											</span>
										</div>
									</li>
								</ul>
											...
											<ul>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<p>Just-in-time PAM and privileged activity orchestration.</p>
															<div class="btn_list">
																<a href="javascript:void(0);" class="custom_btn outline spz-3004-cta">Request Pricing</a>
															</div>
														</div>
												...
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<p>Ensure proper access rights and compliance with automated IGA.</p>
															<div class="btn_list">
												...
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<p>Block undesired AD changes, authentication, and requests in real time.</p>
															<div class="btn_list">
																<a href="javascript:void(0);" class="custom_btn outline spz-3004-cta">Request Pricing</a>
															</div>
														</div>
												...
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															<a href="threat_detection_software.html">Threat Manager</a>
															<p>Detect and respond to AD and Entra ID threats in real time.</p>
															<div class="btn_list">
																<a href="javascript:void(0);" class="custom_btn outline spz-3004-cta">Request Pricing</a>
															</div>
														</div>
												...
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<p>Securely store, manage, and share user passwords.</p>
															<div class="btn_list">
																<a href="javascript:void(0);" class="custom_btn outline spz-3004-cta">Request Pricing</a>
															</div>
														</div>
												...
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<p>Control NetSuite and Salesforce configuration and changes.</p>
															<div class="btn_list">
																<a href="javascript:void(0);" class="custom_btn outline spz-3004-cta">Request Pricing</a>
															</div>
														</div>
											...
											<ul>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<p>Centralize the management of group policies, endpoint configurations, and settings.</p>
															<div class="btn_list">
																<a href="javascript:void(0);" class="custom_btn outline spz-3004-cta">Request Pricing</a>
															</div>
														</div>
												...
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															<a href="endpoint-dlp-solution.html">Endpoint Protector</a>
															<p>Manage and monitor peripheral device usage on endpoints.</p>
															<div class="btn_list">
																<a href="javascript:void(0);" class="custom_btn outline spz-3004-cta">Request Pricing</a>
															</div>
														</div>
		...
		window.addEventListener('click', (e) => {
			...
			const productMap = {
				...
				'#tab1 ul li:nth-child(6) .custom_btn': 'Netwrix 1Secure',

				'#tab2 ul li:first-child .custom_btn': 'Netwrix Privilege Secure',
				'#tab2 ul li:nth-child(2) .custom_btn': 'Netwrix Usercube',
				'#tab2 ul li:nth-child(3) .custom_btn': 'Netwrix GroupID',
				'#tab2 ul li:nth-child(4) .custom_btn': 'Netwrix Threat Prevention',
				'#tab2 ul li:nth-child(5) .custom_btn': 'Netwrix Threat Manager',
				'#tab2 ul li:nth-child(6) .custom_btn': 'Netwrix Enterprise Auditor',
				'#tab2 ul li:nth-child(8) .custom_btn': 'Netwrix Recovery for Active Directory',
				'#tab2 ul li:nth-child(9) .custom_btn': 'Netwrix Password Policy Enforcer',
				'#tab2 ul li:nth-child(10) .custom_btn': 'Netwrix Password Secure',
				'#tab2 ul li:nth-child(11) .custom_btn': 'Netwrix Strongpoint',

				'#tab3 ul li:first-child .custom_btn': 'Netwrix PolicyPak',
				'#tab3 ul li:nth-child(2) .custom_btn': 'Netwrix Endpoint Protector',
				'#tab3 ul li:nth-child(3) .custom_btn': 'Netwrix Change Tracker'
			};

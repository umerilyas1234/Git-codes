...
function loadTestCode3001() {
  if (!document.querySelector("body").classList.contains("spz_t8002")) {
    ...
    const ratingInfo = {
      ...
      ratingStars:
        '<img src="//res.cloudinary.com/spiralyze/image/upload/v1731316440/netwrix/1006/stars_11.svg" alt="Stars rating">',
      rating: '4.5',
					...
					<ul class="splide__list">
						<li class="splide__slide">
							<div class="child first-child">
								<span class="sliderNav desktopOnly">
									<strong><i><img
												src="//res.cloudinary.com/spiralyze/image/upload/v1730299768/netwrix/8002/icon-data.svg"
						...
						<li class="splide__slide">
							<div class="child">
								<span class="sliderNav desktopOnly">
									<strong><i><img
												src="//res.cloudinary.com/spiralyze/image/upload/v1730299768/netwrix/8002/icon-identity.svg"
						...
						<li class="splide__slide">
							<div class="child">
								<span class="sliderNav desktopOnly">
									<strong><i><img
												src="//res.cloudinary.com/spiralyze/image/upload/v1730299768/netwrix/8002/icon-infrastructure.svg"
									...
									<li>
										<div class="products_data">
											...
											<div class="product_bottom">
												...
												<div class="btn_list">
													<a href="#" class="custom_btn">Request Free Trial</a>
									...
									<li>
										<div class="products_data">
											...
											<div class="product_bottom">
												...
												<div class="btn_list">
													<a href="#" class="custom_btn">Download Free Trial</a>
								...
								<ul>
									...
									<li>
										<div class="products_data">
											...
											<div class="product_bottom">
												<h3>Recovery for Active Directory</h3>

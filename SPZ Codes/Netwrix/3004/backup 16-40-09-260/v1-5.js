    ...
    `);
		...
		************************/
		...
		const buttonMappings = [
			...
			{ selector: '#tab1 ul li:nth-child(4)', action: 'Netwrix Data Classification - Download Free Trial' },
			{ selector: '#tab1 ul li:last-child', action: 'Netwrix Threat Manager - Request Free Trial' },
		...
		bindClickEvent('#tab2 ul li:nth-child(6) .product_bottom .btn_list a:first-child', '#tab1 ul li:nth-child(3) .product_bottom .btn_list button');
		bindClickEvent('#tab2 ul li:nth-child(7) .product_bottom .btn_list a:first-child', '#tab1 ul li:last-child .product_bottom .btn_list button');

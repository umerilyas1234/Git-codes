const bodyInterval10001 = setInterval(function () {
	if (document.querySelector('body') && !document.querySelector('.spz_10001')) {
								...
								<div class="accordion">
									...
									<div class="img-wrap">
										<picture>
											...
											<img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/10001/features-eliminate-standing-privilege_1.webp" alt="Eliminate_standing_privilege_image">
										</picture>
									</div>
								</div>
		...
		const first = document.querySelector('.content-part');
		const second = document.querySelector('.slide-part');

		function matchHeight() {
			second.style.height = first.offsetHeight + "px";
		}
		setTimeout(() => {
			matchHeight();
		}, 1500);

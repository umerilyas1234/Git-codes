    ...
    `,
        ...
        <div class="form_main">
          <div class="spz-form-wrap">
              ...
              <div class="step-inner-wrapper">
                  ...
                  <div class="qlf-cta SPZ_QualifyingQuestionsCTA spz_2005_tc">Next</div>
              </div>
      ...
      `;
          ...
          setTimeout(() => {
              ...
              // animateLabels(inputsSelectors, labelValues);
              document.querySelector('.spz_form #SPZ_Test').value = 'control_2013';
          }, 1000);

          function updatedText() {
            const errMsg = document.querySelector('.spz_t2006 .spz-form-wrap form .modelFormError');
            if (errMsg) {
              let html = errMsg.innerHTML;
    
              if (html.includes('Direct Phone cannot be blank.')) {
                errMsg.closest('.spz_t2006 .spz-form-wrap form .modelFormError').classList.add('er_1');
                errMsg.closest('.spz_t2006 .spz-form-wrap form .modelFormError').classList.remove('er_2');
              } else if (html.includes('Please enter a valid Direct Phone')){
                errMsg.closest('.spz_t2006 .spz-form-wrap form .modelFormError').classList.remove('er_1');
                errMsg.closest('.spz_t2006 .spz-form-wrap form .modelFormError').classList.add('er_2');
              }
            }
          }
          // adding caption
          //obeserv the form error class 
          const targetNode = document.querySelector('.spz_form .modelFormError');
          ...
          const callback = (mutationList, observer) => {
              ...
              if (document.querySelector('.spz_form .btn-red-fill').value == "Schedule Demo") {
                  document.querySelector('.spz_form .btn-red-fill').classList.add('spz_2005_tc');

    ...
    `);
		...
		************************/
												...
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="auditor.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="data_classification_software.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="endpoint-dlp-solution.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="enterprise-auditor.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="threat_detection_software.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="strongpoint.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="saas-auditing.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												...
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="identity_governance_and_administration_solution.html"
																	class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="privilege_secure.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="password_policy_enforcer.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="enterprise_password_management_software.html" class="custom_btn outline spz-8002-cta">Learn
																	More</a>
															</div>
														</div>
													</div>
												...
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="group_and_user_management_software.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a herf="javascript:void(0);" class="custom_btn spz-8002-cta">Request Free Trial</a>
																<a href="enterprise-auditor.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												...
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="threat-prevention.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="active_directory_recovery_software.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="active-directory-risk-assessment.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												...
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="endpoint_management_software.html" class="custom_btn outline spz-8002-cta">Learn More</a>
															</div>
														</div>
													</div>
												</li>
												<li>
													<div class="products_data">
														...
														<div class="product_bottom">
															...
															<div class="btn_list">
																<a href="security_configuration_management_software.html" class="custom_btn outline spz-8002-cta">Learn
																	More</a>
															</div>
														</div>
													</div>
		...
		const buttonMappings = [
			{ selector: '#tab1 ul li:first-child', action: 'Netwrix Auditor - Download Free Trial' },
			{ selector: '#tab1 ul li:nth-child(2)', action: 'Netwrix Data Classification - Download Free Trial' },
			{ selector: '#tab1 ul li:nth-child(3)', action: 'Netwrix Endpoint Protector - Request Free Trial' },
			{ selector: '#tab1 ul li:nth-child(4)', action: 'Netwrix Enterprise Auditor - Request Free Trial' },
			{ selector: '#tab1 ul li:nth-child(5)', action: 'Netwrix Threat Manager - Request Free Trial' },
			{ selector: '#tab1 ul li:nth-child(6)', action: 'Netwrix Strongpoint - Request Free Trial' },
			{ selector: '#tab1 ul li:nth-child(7)', action: 'Netwrix 1Secure - Request Free Trial' },
		...
		buttonMappings.forEach(({ selector, action }) => {
			...
			button.classList.add('spz-8002-cta');
			if (target && button) target.insertAdjacentElement('afterbegin', button);
		});

		function bindClickEvent(sourceSelector, targetSelector) {
			document.querySelector(sourceSelector)?.addEventListener('click', () => {
				document.querySelector(targetSelector)?.click();
			});
		}

		bindClickEvent('#tab2 ul li:nth-child(6) .product_bottom .btn_list a:first-child', '#tab1 ul li:nth-child(4) .product_bottom .btn_list button');
		bindClickEvent('#tab2 ul li:nth-child(7) .product_bottom .btn_list a:first-child', '#tab1 ul li:nth-child(5) .product_bottom .btn_list button');
...
var bodyInterval = setInterval(() => {
	if (document.querySelectorAll("body").length > 0 && document.querySelectorAll('.product-button button').length==18) {

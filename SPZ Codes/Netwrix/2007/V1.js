...
function loadTestCode2007() {
  if (!document.querySelector("body").classList.contains("spz_t2007")) {
    ...
    setTimeout(() => {
      ...
      document.querySelector(`.spz_t2007 > div:nth-of-type(${containerIndex}) form`).classList.add("spz_form");
      ...
      ************************/
            ...
            <div class="form_main">
              <div class="spz-form-wrap">
                  <div class="qlf-form">
                      ...
                      <div class="qlf-cta SPZ_QualifyingQuestionsCTA spz_2006_cta">Next</div>
                  </div>
      ...
      setTimeout(() => {
        ...
        document.querySelector('.spz_form #SPZ_Test').value = 'variant_2007';
      }, 1000);
      ...
      const callback = (mutationList, observer) => {
        ...
        if (document.querySelector('.spz_form .btn-red-fill').value == "Schedule Demo") {
          document.querySelector('.spz_form .btn-red-fill').classList.add('spz_2006_cta');

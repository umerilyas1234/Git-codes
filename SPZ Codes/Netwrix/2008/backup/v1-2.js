      ...
      window.addEventListener('click', function (e) {
        if (e.target.matches('.spz_form .modelFormSubmit')) {
          setTimeout(() => {
            ...
            if (!formEl.classList.contains('formProgressive') && errorElem && errorElem.textContent.includes('Number of Employees') && !emailValid) {
              console.log('Email is empty');
              errorElem.classList.add('email_active');
            } else if (!formEl.classList.contains('formProgressive') && accountType === '' && errorElem && email !== '') {
              console.log('Account type is empty');
              if (errorElem.classList.contains('email_active')) {
                errorElem.classList.remove('email_active');
              }
              errorElem.classList.add('userTyple_active');
            } else if (formEl.classList.contains('formProgressive') && nsrvSelect && selectedValue === '' || selectedValue.includes('select')) {
              if (errorElem.classList.contains('email_active') || errorElem.classList.contains('userTyple_active')) {
                errorElem.classList.remove('email_active', 'userTyple_active');
              }

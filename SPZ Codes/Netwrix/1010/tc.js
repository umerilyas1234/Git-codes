const bodyInterval1001 = setInterval(function () {
  if (document.querySelector('body') && !document.querySelector('.spz-1001') && document.querySelector('.gradient')) {
    ...
    document.querySelector('body').classList.add("spz_t1003");
						...
						<div class="content-wrap">
							<div class="content-part">
								<div class="accordion">
									...
									<div class="accor-paratexts">
										...
										<div class="ctaWrapper">
											<a class="spz_1010_tc" href="https://www.netwrix.com/one-to-one.html">Get a Demo</a>
											<button class="spz_1010_tc">Contact Our Experts</button>
										</div>
									</div>
									<div class="img-wrap">
										<picture>
											<source media="(max-width:1023px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/risk_assessment_tablet_and_mobile.webp">
											<img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/risk_assessment.webp" alt="Risk Assessment_image">
										</picture>
									</div>
								</div>
								...
								<div class="accordion ">
									...
									<div class="img-wrap">
										<picture>
											<source media="(max-width:1023px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/threat_detection__response_tm_1.webp">
											<img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/threat_detection__response_1.webp" alt="Threat Detection & Response_image">
										</picture>
									</div>
								</div>
								...
								<div class="accordion">
									...
									<div class="img-wrap">
										<picture>
											<source media="(max-width:1023px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/policy_enforcement_tm.webp">
											<img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/policy_enforcement.webp" alt="Policy Enforcement_image">
										</picture>
									</div>
								</div>
								...
								<div class="accordion">
									...
									<div class="img-wrap">
										<picture>
											<source media="(max-width:1023px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/rollback__recovery_tm_1.webp">
											<img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/rollback__recovery_1.webp" alt="Rollback & Recovery_image">
										</picture>
									</div>
								</div>
								...
								<div class="accordion">
									...
									<div class="img-wrap">
										<picture>
											<source media="(max-width:1023px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/management_tm.webp">
											<img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/management.webp" alt="Management_image">
										</picture>
									</div>
								</div>
								...
								<div class="accordion">
									...
									<div class="img-wrap">
										<picture>
											<source media="(max-width:1023px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/governance__compliance_tm_1.webp">
											<img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/governance__compliance_1.webp" alt="Governance & Compliance_image">
										</picture>
									</div>
								</div>
								...
								<div class="accordion">
									...
									<div class="img-wrap">
										<picture>
											<source media="(max-width:1023px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/integrations_tm.webp">
											<img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/integrations.webp" alt="Integrations_image">
										</picture>
									</div>
								</div>
							</div>
							...
							<div class="slide-part">
								<div class="accordion_images">
									...
									<div class="image-container slide-6">
										<picture>
											<source media="(max-width:1023px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/governance__compliance_tm_1.webp">
											<img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/1003/governance__compliance_1.webp" alt="Governance & Compliance image">
										</picture>
									</div>
    ...
    document.querySelectorAll('.spz_t1003 .accrodion-section .content-part .accordion button').forEach(contactCTA => {

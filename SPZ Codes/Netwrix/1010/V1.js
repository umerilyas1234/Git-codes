const bodyInterval1010 = setInterval(function () {
	if (document.querySelector('body') && !document.querySelector('.spz_t1010')) {
		...
		const accordionVideos = [
			'//res.cloudinary.com/spiralyze/video/upload/v1744036603/netwrix/1010/Vid/1.mp4',
			'//res.cloudinary.com/spiralyze/video/upload/v1744036604/netwrix/1010/Vid/2.mp4',
			'//res.cloudinary.com/spiralyze/video/upload/v1744036604/netwrix/1010/Vid/3.mp4',
			'//res.cloudinary.com/spiralyze/video/upload/v1744036604/netwrix/1010/Vid/4.mp4',
			'//res.cloudinary.com/spiralyze/video/upload/v1744036605/netwrix/1010/Vid/5.mp4',
			'//res.cloudinary.com/spiralyze/video/upload/v1744036604/netwrix/1010/Vid/6.mp4',
			'//res.cloudinary.com/spiralyze/video/upload/v1744036604/netwrix/1010/Vid/7.mp4'
		];

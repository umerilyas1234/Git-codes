	...
	if (!document.querySelector("body").classList.contains("spz_t2006")) {
      ...
      `,
        ...
        `,
            ...
            <div class="form_main">
              <div class="spz-form-wrap">
                  <div class="qlf-form">
                      ...
                      <div class="qlf-cta SPZ_QualifyingQuestionsCTA spz2006_tc">Next</div>
                  </div>
          ...
          document.querySelector('.spz_form #SPZ_Test').value = "control_2012"
        } else {
          document.querySelector('.spz_form #SPZ_Test').value = document.querySelector('.spz_form #SPZ_Test').value + ",control_2012";
        }
        if (document.querySelector('.spz_form .btn-red-fill').value == "Schedule Demo") {
          document.querySelector('.spz_form .btn-red-fill').classList.add('spz2012_tc');

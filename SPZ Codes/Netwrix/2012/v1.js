...
function loadTestCode2006() {
	if (!document.querySelector("body").classList.contains("spz_2012_v1")) {
		document.querySelector("body").classList.add("spz_2012_v1");
		setTimeout(() => {
			const containerIndex = document.querySelector('.cookie-information-cont') ? 6 : 5;
			document.querySelector(`.spz_2012_v1 > div:nth-of-type(${containerIndex}) form`).classList.add("spz_form");
            ...
            <div class="form_main">
              <div class="spz-form-wrap">
                  <div class="qlf-form">
                      ...
                      <div class="step-inner-wrapper">
                        <div class="steps-control">
                            ...
                            <label for="checkbox_item_1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                                  <path d="M12.6152 19.132H26.8627" stroke="#4D7C7C" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                  <path d="M12.6152 24.9141V5.71439" stroke="#4D7C7C" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                  <path d="M25.5671 5.63818H7.4339C6.71857 5.63818 6.13867 6.21808 6.13867 6.93341V25.0666C6.13867 25.7819 6.71857 26.3618 7.4339 26.3618H25.5671C26.2824 26.3618 26.8623 25.7819 26.8623 25.0666V6.93341C26.8623 6.21808 26.2824 5.63818 25.5671 5.63818Z" stroke="#4D7C7C" stroke-width="2.5"></path>
                                </svg>
                        ...
                        <div class="steps-control">
                            ...
                            <label for="checkbox_item_2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                                  <path d="M26.5189 8.33959C27.3777 8.71809 27.9502 9.52232 27.9502 10.4211C27.9502 22.7208 18.8374 28.5868 16.4518 28.5868C14.0662 28.5868 5.04883 22.6262 5.04883 10.4211C5.04883 9.52232 5.57365 8.71809 6.43245 8.33959L15.593 4.55507C15.8793 4.46045 16.1655 4.41315 16.4995 4.41315C16.7858 4.41315 17.072 4.46045 17.3583 4.55507L26.5189 8.33959ZM16.4995 26.3161C20.9367 24.4712 25.6601 18.6525 25.6601 10.4211L16.4995 6.63655L7.33897 10.4211C7.33897 18.4633 11.8238 24.4239 16.4995 26.3161Z" fill="#D22730" stroke="#D22730" stroke-width="0.5"></path>
                                  <path d="M16.5 17.1902V19.7475" stroke="#D22730" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                  <path d="M16.5005 17.6512C18.1042 17.6512 19.4043 16.3511 19.4043 14.7474C19.4043 13.1437 18.1042 11.8436 16.5005 11.8436C14.8968 11.8436 13.5967 13.1437 13.5967 14.7474C13.5967 16.3511 14.8968 17.6512 16.5005 17.6512Z" fill="#D22730"></path>
                                </svg>
                        ...
                        <div class="steps-control">
                            ...
                            <label for="checkbox_item_3">
                              <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                                <path d="M19.1289 16H28.0912" stroke="#FF8200" stroke-width="2.5" stroke-linecap="round"></path>
                                <path d="M5.0459 16H14.0082" stroke="#FF8200" stroke-width="2.5" stroke-linecap="round"></path>
                                <path d="M16.5576 13.4394V4.47708" stroke="#FF8200" stroke-width="2.5" stroke-linecap="round"></path>
                                <path d="M16.5576 27.523V18.5607" stroke="#FF8200" stroke-width="2.5" stroke-linecap="round"></path>
                                <path d="M26.1514 22.4017C27.3771 20.5707 28.0918 18.3688 28.0918 16C28.0918 9.63603 22.9327 4.47708 16.5688 4.47708C14.9794 4.47708 13.4652 4.79888 12.0877 5.38088M6.58746 10.2386C5.60704 11.9334 5.0459 13.9012 5.0459 16C5.0459 22.364 10.2048 27.523 16.5688 27.523C18.1582 27.523 19.6726 27.2012 21.05 26.6192" stroke="#FF8200" stroke-width="2.5" stroke-linecap="round"></path>
                                <path d="M21.674 16C21.674 17.3692 21.1371 18.613 20.2625 19.5319C19.3304 20.5111 18.015 21.1213 16.5573 21.1213C13.7313 21.1213 11.4404 18.8284 11.4404 16C11.4404 13.1715 13.7313 10.8787 16.5573 10.8787C19.3832 10.8787 21.674 13.1715 21.674 16Z" stroke="#FF8200" stroke-width="2.5"></path>
                                <path d="M8.71986 11.5934L7.47643 8.31802L4.40527 9.51346" stroke="#FF8200" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M24.251 21.1213L24.8733 24.5694L28.1114 23.9579" stroke="#FF8200" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
                              </svg>
                        ...
                        <div class="steps-control">
                            ...
                            <label for="checkbox_item_4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                                  <path d="M6.05762 11.1022L8.19961 8.84119" stroke="#E98CDA" stroke-width="3" stroke-linecap="round"></path>
                                  <path d="M9.48047 14.753L11.6225 12.4921" stroke="#E98CDA" stroke-width="3" stroke-linecap="round"></path>
                                  <path d="M5.83398 6.50012L15.2682 14.7783" stroke="#E98CDA" stroke-width="3" stroke-linecap="round"></path>
                                  <path d="M14.6143 19.9028C14.6143 23.3713 17.426 26.1831 20.8944 26.1831C24.363 26.1831 27.1747 23.3713 27.1747 19.9028C27.1747 16.4344 24.363 13.6226 20.8944 13.6226C17.426 13.6226 14.6143 16.4344 14.6143 19.9028Z" stroke="#E98CDA" stroke-width="3"></path>
                                </svg>
                        ...
                        <div class="steps-control">
                            ...
                            <label for="checkbox_item_6">
                              <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                                <path d="M16.9307 19.5043V22.5208" stroke="#6929C4" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M16.9302 20.7362C18.5339 20.7362 19.834 19.4362 19.834 17.8324C19.834 16.2287 18.5339 14.9286 16.9302 14.9286C15.3264 14.9286 14.0264 16.2287 14.0264 17.8324C14.0264 19.4362 15.3264 20.7362 16.9302 20.7362Z" fill="#6929C4"></path>
                                <path d="M16.8834 28.7275C16.9139 28.738 16.9465 28.7379 16.977 28.7271C21.8263 27.0037 26.9687 21.6511 27.0151 14.086C27.0154 14.0247 26.9766 13.9693 26.9187 13.9491L16.9778 10.4849C16.9471 10.4741 16.9137 10.4741 16.883 10.4849L6.94205 13.9491C6.88417 13.9693 6.84533 14.0246 6.84571 14.0858C6.89073 21.4793 11.7765 26.9609 16.8834 28.7275Z" stroke="#6929C4" stroke-width="2.5"></path>
                                <path d="M11.168 11.909V6.14619C11.168 4.55483 12.458 3.26477 14.0494 3.26477H19.8122C21.4036 3.26477 22.6937 4.55483 22.6937 6.14619V7.58691" stroke="#6929C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                              </svg>
                      ...
                      <div class="qlf-cta SPZ_QualifyingQuestionsCTA spz2012_v1">Next</div>
                  </div>
          ...
          `;
			...
			setTimeout(() => {
				...
				if (document.querySelector('.spz_form #SPZ_Test').value == "") {
					document.querySelector('.spz_form #SPZ_Test').value = "variant_2012"
				} else {
					document.querySelector('.spz_form #SPZ_Test').value = document.querySelector('.spz_form #SPZ_Test').value + ",variant_2012";
				}

				// variant 2012
				document.querySelector('.spz_2012_v1 .form_main .spz-form-wrap').insertAdjacentHTML('afterend', `
        <div class="spz__testimonial__wrapper">
          <div class="spz__testimonial__stat">
              <span class="spz__testimonial__stat-value">85%</span>
              <span class="spz__testimonial__stat-text">less time auditing</span>
          </div>
          <p class="spz__testimonial__text">
              “Extremely helpful. I can investigate an&nbsp;incident in a few clicks, whereas before it would take hours to dig through logs.”
          </p>
          <div class="spz__testimonial__author">
              <div class="spz__testimonial__author-content">
                  <span class="spz__testimonial__author-name">Boytcho Boytchev</span>
                  <span class="spz__testimonial__author-position">Information Security Officer</span>
              </div>
              <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/netwrix/2012/logo_webp_1.webp" alt="Credissimo logo" class="spz__testimonial__author-image">
          </div>
        </div>
       `);
				if (document.querySelector('.spz_form .btn-red-fill').value == "Schedule Demo") {
					document.querySelector('.spz_form .btn-red-fill').classList.add('spz2012_v1');
			...
			function updatedText() {
				...
				if (errMsg) {
					...
					if (html.includes('Direct Phone cannot be blank.')) {
						errMsg.closest('.spz_form .modelFormError').classList.add('er_1');
						errMsg.closest('.spz_form .modelFormError').classList.remove('er_2', 'er_3', 'er_4');
					} else if (html.includes('Email cannot be blank')) {
						errMsg.closest('.spz_form .modelFormError').classList.add('er_2');
						errMsg.closest('.spz_form .modelFormError').classList.remove('er_1', 'er_3', 'er_4');
					} else if (html.includes('e-mail')) {
						errMsg.closest('.spz_form .modelFormError').classList.add('er_3');
						errMsg.closest('.spz_form .modelFormError').classList.remove('er_1', 'er_2', 'er_4');
					} else if (html.includes('Please enter a valid Direct Phone.')) {
						errMsg.closest('.spz_form .modelFormError').classList.add('er_4');
						errMsg.closest('.spz_form .modelFormError').classList.remove('er_1', 'er_3', 'er_2');
					} else {
						errMsg.closest('.spz_form .modelFormError').classList.remove('er_1', 'er_2', 'er_3', 'er_4');
					}
				}
			}
			...
			const targetNode = document.querySelector('.spz_form input.btn');

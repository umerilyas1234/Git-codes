...
function injectVariant6015() {
			...
			infoSection.insertAdjacentHTML('afterbegin', `
					<div class="spz__info">
							...
							<div class="spz__info__ctas">
									<button class="spz__info__ctas__button c--hero-e__wrapper__content__list-group__item spz6015_v1">Free download</button>
									<button class="spz__info__ctas__button c--hero-e__wrapper__content__list-group__item spz6015_v1">Launch in-browser demo</button>
							</div>
					</div>
			`);
					...
					if (capabilitiesSection) {
							...
							const ctaRow = `
									<div class="spz__capabilities__cta-row">
											<button class="spz__capabilities__cta-button c--hero-e__wrapper__content__list-group__item spz6015_v1">Free download</button>
											<button class="spz__capabilities__cta-button c--hero-e__wrapper__content__list-group__item spz6015_v1">Launch in-browser demo</button>
									</div>
							`;
	...
	const variantName = `variant2_` + expName; //variantName should be variant_, true_control_ etc.

function loadTestCode2002() {
  if (!document.querySelector("body").classList.contains("spz_t2002")) {
    ...
    document.querySelector("body > div:nth-of-type(5) form").classList.add("spz_form");
    ...
    ${ /*This html goes is inserted before the form */''}
      <div class="form_logo"><img src="//res.cloudinary.com/spiralyze/image/upload/v1726744775/netwrix/2002/logo__colored.svg" alt="logo"></div>
      <div class="form_heading">
        <h2>Get a demo</h2>
      </div>
      <div class="subheading">
        <div class="rating"><img src="//res.cloudinary.com/spiralyze/image/upload/v1729855208/netwrix/2002/frame_3.svg" alt="Gartner"><strong><img src="//res.cloudinary.com/spiralyze/image/upload/v1726744775/netwrix/2002/stars.svg" alt="Rating stars"><span><b>4.4 </b> (142 reviews)<sup>*</sup></span></strong></div>
      </div>  
    `,
      customHTMLAfter: `

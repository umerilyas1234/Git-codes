    ...
    setTimeout(() => {
      ...
      `,
        ...
        <div class="securityInfo">  
          ...
          <a href="https://www.netwrix.com/support.html" class="privacyLink"> Netwrix Technical Support section</a>
        </div>
        `,
      };
      ...
      const labelValues = ["First Name", "Last Name", "Email", "Inquiry Type", "Phone", "# of Employees", "Additional Message"]
      ...
      ************************/
      ...
      setTimeout(() => {
        ...
        function handleValidation() {
          ...
          if (firstName !== '' && lastName !== '' && email !== '' && category !== '' && emailValid) {
          ...
          } else if (!emailValid && email !== '' && email.includes('@')) {

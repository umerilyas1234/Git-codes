      ...
      ************************/
      ...
      <div class="spz-3008-section3">
        <div class="gartner">
          ...
          <div class="border"></div>
          <div class="right">
            <img src="//res.cloudinary.com/spiralyze/image/upload/v1732805123/netwrix/8002/rating_47.svg" alt="Star Icon" width="108" height="20">
      ...
      const footerNote = document.querySelector('.spz-3008 .footer-note');
      if (footerNote) {
        footerNote.innerHTML = footerNote.innerHTML.replace('143', '186');
      }  
    }
  },10)
  setTimeout(function(){

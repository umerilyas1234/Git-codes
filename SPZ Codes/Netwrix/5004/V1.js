  ...
  if (!document.querySelector("body").classList.contains("spz_t5004")) {
    ...
    setTimeout(() => {
      const triageData = [
        //Question 1 start
        {
          questionSuperHeading: "Get Your Free Trial",
      ...
      const sectionSelector = `.form_request_container`
      ...
      const formUniqueSelector = "#modalFormRequestContainer" //<--- form uqniue selector goes here. e.g.
      ...
      ************************/
      function addTriage(triageData, formSelector) {
            ...
            return `
              ...
              return `
                  ...
                  ``
                      ...
                      <div class="next-question spz_5004_v1">Next</div>
                  </div>
                  `
          }).join('')
          }
        ...
        document.querySelectorAll('.answer-item').forEach((item, index) => {
          item.addEventListener('click', (e) => {
            ...
            if (["1-150", "151-500", "501-2,000", "2,001-7,500", "7,501-25,000", "25,000+"].includes(answerText)) {
              ...
              // document.querySelector('#modalFormRequestContainer #number_of_computers').value = value;
        ...
        function loadSelections() {
          ...
          if (computersRange) {
            ...
            // document.querySelector('#modalFormRequestContainer #number_of_computers').value = computersRange;
        ...
        document.querySelectorAll('.next-question').forEach((item, index) => {
          item.addEventListener('click', (e) => {
            if (item.classList.contains('step_one')) {
              ...
              if ([...question_oneItem].some(item => item.classList.contains('selected'))) {
                removeError();
              } else {
              ...
              if ([...question_twoItem].some(item => item.classList.contains('selected'))) {
                removeError();
              } else {
                showError('Please select at least one option.', item);
                return;
      ...
      setTimeout(() => {
        var privacyNote = document.querySelector('.cf-privacy-policy-notice');
        ...
        document.querySelector("#modalFormRequestContainer").insertAdjacentElement("afterend", privacyNote);
        document.querySelector('#productDTModal .cf-button').classList.add('spz_5004_v1');
      ...
      document.querySelectorAll('#modalFormRequestContainer .cf-input').forEach(function (inputField) {
    ...
    //   localStorage.clear();
    //   setTimeout(() => {
    //     if (document.querySelector('#modalFormRequestContainer').style.display === 'none') {
    ...
    var spzHiddenFieldName = setInterval(() => {
      if (document.querySelectorAll('input[name="SPZ_Test"]').length > 0) {
        ...
        setTimeout(() => {
          document.querySelectorAll('input[name="SPZ_Test"]')[0].value = 'variant_5004';
        }, 1000);
      }
    }, 100);

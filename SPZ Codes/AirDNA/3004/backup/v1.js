  ...
  if (!document.querySelector('body').classList.contains('spz_3004_v1')) {
    ...
    if (document.querySelector('.spz_3004_v1 main > section:nth-child(3)')) {
        ...
        accordionItems: [
          ...
          },
          {
            ...
            image: [
              {
                breakPoint: 1024,
                url: "//res.cloudinary.com/spiralyze/image/upload/f_auto/airdna/3004/integrations__api-1440_768_362.webp",
              },
              {
                breakPoint: 768,
                url: "//res.cloudinary.com/spiralyze/image/upload/f_auto/airdna/3004/integrations__api-1440_768_362.webp",
      ...
      function initAccordion(content, whereToPut, sectionSelector) {
        ...
        // Scroll to active content on mobile
        function scrollToActiveContent(activeElement) {
          ...
          setTimeout(() => {
            ...
            // Scroll to position the element with 100px margin from top
            window.scrollTo({
              top: elementTop - 50,
              behavior: 'smooth'
            });
        ...
        Array.from(accordionContents.children).forEach((item, index) => {
          ...
          item.addEventListener('click', (e) => {
            ...
            if (currentActive !== index) {
              ...
              // Even if it's the same item, scroll to it on mobile
              scrollToActiveContent(item);
            }
          });
        ...
        window.addEventListener('resize', () => {
          // If we're on mobile and there's an active item, scroll to it
          if (isMobileScreen()) {
            const activeItem = document.querySelector('.spz-features-accordion__contents > .content.active');
            if (activeItem) {
              scrollToActiveContent(activeItem);
            }
          }
        });
      }
...
function removeTest() {
  ...
  document.querySelector('body').classList.remove('spz_3004_v1');
}

const selector3004 = 'main > section:nth-child(3)';

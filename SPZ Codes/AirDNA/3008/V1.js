...
function spz5002Test() {
  if (!document.querySelector('body').classList.contains('spz_3008')) {
    ...
    if (document.querySelector('.spz_3008 main > section:first-child')) {
      document.querySelector('.spz_3008 main > section:first-child').classList.add('original_hero', 'v2');
      ...
      if (document.querySelector('.original_hero')) {
        ...
        document.querySelector('.spz_3008 .original_hero > div > div:nth-child(2) > div > div:nth-child(2) > div > div > div .MuiOutlinedInput-root input').insertAdjacentHTML('afterend', '<label>Search any market, city, or neighborhood</label>');
      }

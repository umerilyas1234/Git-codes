                          ...
                          <li class="splide__slide">
                            <div class="product_list" id="tab2">
                              <div class="products_data">
                                ...
                                <div class="product_bottom">
                                  <picture>
                                    <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/airdna/3008/ui-360-step3.webp">
                          ...
                          <li class="splide__slide">
                            <div class="product_list" id="tab3">
                              <div class="products_data">
                                ...
                                <div class="product_bottom">
                                  <picture>
                                    <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/airdna/3008/ui-360-step2.webp">
      ...
      loadJS('https://cdn.jsdelivr.net/npm/@splidejs/splide@4.0.1/dist/js/splide.min.js', function () {
        ...
        splidebottom.on('moved', function (newIndex) {
          ...
          if (activeSlide && activeSlide.id === 'splide01-slide01') {
            ...
            document.querySelector('.spz_3008 .original_hero > div > div:nth-child(2) > div > div:nth-child(2) > div > div > div .MuiOutlinedInput-root label').textContent = 'Search any market: city, neighborhood, or destination';
...
const selector5002 = 'main > section:first-child';

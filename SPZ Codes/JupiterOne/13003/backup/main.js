...
function loadTestCode13003() {
  if (!document.querySelector("body").classList.contains("spz_t13003")) {
    ...
    <div class="hero_section">
        <div class="auto_container">
            <div class="hero_inner">
              <div class="hero_logo">
                  <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/jupiterone/13003/logos.webp" alt="JupiterOne & WatchTowr Icon">
              </div>
              ...
              <div class="slider-wrapper">
                <div class="slider">
                  ...
                  <div class="slide num5" data-type="after">
                    <div class="slide_data">
                        <picture>
                  ...
                  <div class="slide num1" data-type="">
                    <div class="slide_data">
                      <picture>
    ...
    const loadVideoAnimation = function () {
      function panningNext() {
        const slides = document.querySelectorAll('.slide');
        const container = document.querySelector('.slider');

        // Reset all slides' dataset.type and classes
        slides.forEach(e => {
          e.dataset.type = '';
          e.style = '';
        ...
        // Update the dataset types and apply animations
        slides[0].dataset.type = '';
        slides[0].classList.add('fade-out');
        gsap.to('.fade-out', { duration: 1, transform: 'translatex(-200px)', scale: '0.8' });

        slides[1].dataset.type = 'active';
        slides[1].classList.add('to-left');
        gsap.from('.to-left', { duration: 1, transform: 'translatex(100px)' });

        slides[2].dataset.type = 'after';
        slides[2].classList.add('fade-in');
      ...
      function startSlider() {
        setInterval(panningNext, 8000);
      }

      startSlider();
    }

    loadJS_SPZ(gsapJsURL, loadVideoAnimation, document.body);
        ...
        <div class="auto_container">
            <div class="video_inner">
                ...
                <div class="video_main">
                    ...
                    <iframe id="vimeo-video" src="https://player.vimeo.com/video/942966706?autoplay=1&muted=1&controls=1" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
                </div>
            </div>
        </div>
     </div> 
    ...
    document.querySelector('.section-blue-banner2>div>img').src = "//res.cloudinary.com/spiralyze/image/upload/f_auto/jupiterone/13003/logo_icons.webp";

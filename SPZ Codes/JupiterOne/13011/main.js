...
link.type = "text/css";
link.href =
  "//res.cloudinary.com/spiralyze/raw/upload/v1731679706/JupiterOne/13011/src/styles.css";
if (
  !document.querySelector(
    'link[href="//res.cloudinary.com/spiralyze/raw/upload/v1731679706/JupiterOne/13011/src/styles.css"]'
  )
) {
...
function loadTestCode13003() {
  if (!document.querySelector("body").classList.contains("spz_t13011")) {
    document.querySelector("body").classList.add("spz_t13011");
    ...
    const hiddenValueInterval = setInterval(function () {
      if (document.querySelector('[name=spiralyze_testing_hidden_field]')) {
        ...
        document.querySelector('[name=spiralyze_testing_hidden_field]').value = "variant_13011";
      }
      ...
      <div class="how_itWorks">
        <div class="auto_container">
          <div class="how_itWorks_inner">
            <div class="how_itWorks_detail">
              <h2>How it works</h2>
              <p>Explore how security teams can speed up threat response by prioritizing vulnerabilities with automated red teaming and attack path analysis in our self-guided tour.</p>
            </div>
            <div class="how_itWorks_data">
              <div class="iframe_outer">
                <iframe src="https://capture.navattic.com/cm1kt1tsp000003l76sldcbuv" style="border:none;width:100%;" allow="fullscreen" data-navattic-demo-id="cm1kt1tsp000003l76sldcbuv"></iframe>
              </div>
              <a href="https://info.jupiterone.com/book-a-demo-cyber-asset-attack-surface-management"
                class="button-tile w-button spz-cta-13011">Get a Demo</a>
            </div>
          </div>
        </div>
      </div>
    ...
    // grid section
    document.querySelector('.how_itWorks').insertAdjacentHTML('afterend', `
                ...
                <div class="grid_container">
                    ...
                    <div class="grid_item item3">
                        <picture>
                            ...
                            <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/jupiterone/13003/quantify_risk.webp" alt="Quantify Risk">                  
                        </picture>
                        <h3>Quantify Risk</h3>

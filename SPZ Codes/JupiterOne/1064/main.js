        ...
        if (document.querySelector('.demo_form .hs-input')) {
          ...
          var spzHiddenFieldName = setInterval(() => {
            if (document.querySelectorAll('input[name="spiralyze_testing_hidden_field"]').length > 0) {
              ...
              setTimeout(() => {
                document.querySelector('input[name="spiralyze_testing_hidden_field"]').value = 'variant_#1064';
              }, 1000);
            }
          }, 100);
        ...
        checkboxes.forEach(function (checkbox) {
          if (checkbox.checked) {
            if (checkbox.value == 'Cyber asset management') {
              console.log('Cyber asset management');
              selectedTexts.push(' cyber asset management');
            } else if (checkbox.value == 'Exposure management') {
              console.log('Exposure management');
              selectedTexts.push('exposure management');
            } else if (checkbox.value == 'Security posture management') {
              console.log('Security posture management');
              selectedTexts.push('security posture management');
            } else if (checkbox.value == 'External attack surface management') {
              console.log('External attack surface management');
              selectedTexts.push('external attack surface management');

...
function loadTestCode13010() {
  if (!document.querySelector("body").classList.contains("spz_t13010")) {
    ...
    document.querySelector('.section-stop-adblocker').closest('section').remove();
                  ...
                  <div class="w-col w-col-6 w-col-stack">
                    <picture>
                      <source media="(max-width:767.98px)"
                        srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/jupiterone/13010/why_continuous_controls_monitoring_mobile.webp">
                      <source media="(max-width:1023.98px)"
                        srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/jupiterone/13010/why_continuous_controls_monitoring_tablet.webp">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/jupiterone/13010/why_continuous_controls_monitoring.webp"
                          ...
                          <div class="solutionContent">
                            <div class="ContentInner">
                              ...
                              <div class="imgWrapper">
                                <picture>
                                  <source media="(max-width:767.98px)"
                                    srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/jupiterone/13010/real-time_reporting_mob_3.webp">
                                  <source media="(max-width:1023.98px)"
                                    srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/jupiterone/13010/real-time_reporting_1.webp">
                                  <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/jupiterone/13010/real-time_reporting_1.webp"
                          ...
                          <div class="solutionContent">
                            <div class="ContentInner">
                              ...
                              <div class="imgWrapper">
                                <picture>
                                  <source media="(max-width:767.98px)"
                                    srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/jupiterone/13010/ready-made_frameworks_mob_1.webp">
                                  <source media="(max-width:1023.98px)"
                                    srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/jupiterone/13010/ready-made_frameworks_1.webp">
                                  <img
                                    src="//res.cloudinary.com/spiralyze/image/upload/f_auto/jupiterone/13010/ready-made_frameworks_1.webp"

...
if (!document.querySelector('link[href="https://cdn.jsdelivr.net/npm/@splidejs/splide@4.0.1/dist/css/splide.min.css"]')) {
      ...
      if (document.querySelectorAll('.demo_form input[name="spiralyze_testing_hidden_field"]').length > 0) {
        ...
        setTimeout(() => {
          document.querySelectorAll('.demo_form input[name="spiralyze_testing_hidden_field"]').forEach(function (e) {
            e.value = 'control_#1070'
          });

          document.querySelector('.modal_form_wrapper .modal-get-form .hs-form .hs_submit .hs-button').classList.add('spz_1070_tc');
          document.querySelector('.modal_form_wrapper .demo_form form.hs-form .hs_submit .hs-button').classList.add('spz_1070_tc');
        }, 1000);
      }
    }, 100);

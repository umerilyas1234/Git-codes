...
function spz1014Code() {
  ...
  var hasBodyClass = document.querySelector('body').classList.contains('spz_1013_v1');
  ...
  if (!hasBodyClass || !hasSpzSections) {
    if (!hasBodyClass) {
      document.querySelector('body').classList.add('spz_1013_v1');
    }
  ...
  <div class="spz_hero">
    ...
    <div class="hero_form">
      <div class="form_heading">
        ...
        <h4>Plans start at <strong>$3.99/mo.</strong></h4>
      </div>
  ...
  <div class="spz_testimonials">
    ...
    window.addEventListener('click', function (e) {
      ...
      if (e.target.classList.contains('awr-header-logo')){
        // document.querySelector('.awr-footer__container>a').click();
        setTimeout(function(){
...
function spz1014Test() {
  if (!document.querySelector('body').classList.contains('spz_1013_v1')) {
    document.querySelector('body').classList.add('spz_1013_v1', "v2");
  }
}
...
function removeTest() {
  ...
  document.querySelector('body').classList.remove('spz_1013_v1');
...
const observer = new MutationObserver(() => {
  ...
  if (currentPage === previousUrl) {
    ...
    if (selectorElement) {
      var hasSpzClass = document.querySelector('body').classList.contains('spz_1013_v1');
      var hasSpzSections = document.querySelector('.spz_sections');

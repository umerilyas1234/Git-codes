...
function resizeChanges() {
  if (window.location.href === 'https://www.awrusa.com/' || window.location.href === 'https://oncourse-portal-qa.ohscloud.net/' || window.location.search.includes('_vis_preview_data')) {
    if (window.innerWidth >= 1024) {
          ...
          if (!document.querySelector('.spz-banner-tags')) {
              if (window.location.href === "https://www.awrusa.com/" ||window.location.href === "https://oncourse-portal-qa.ohscloud.net/" || window.location.href.includes("?_vis_preview_data")) {
                const heading = document.querySelector('.awr-rich-text h2');
                if (heading) {
...
function heroBannerMainV1() {
    if (!document.body.classList.contains('spz_1007_v1') && (window.location.href === 'https://www.awrusa.com/' || window.location.href === 'https://oncourse-portal-qa.ohscloud.net/' || window.location.search.includes('_vis_preview_data'))) {
...
//   // Observe DOM mutations (SPA often changes DOM when route changes)
//   const observer = new MutationObserver(() => {
//     if (location.href !== lastUrl) {
//       lastUrl = location.href;
//       console.log("URL changed:", lastUrl);

//       // :white_check_mark: Call your custom function here
//     }
//   });

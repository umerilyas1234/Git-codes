  ...
  <div class="spz_testimonials">
    ...
    function updatedPlan() {
      ...
      if (document.querySelector('.plan_slider').classList.contains('detroit')) {
        ...
        secondAnchorTwo.href = 'https://www.awrusa.com/fortwayne/plan/43/water-line-and-sewer-line-protection-program';
    ...
    if (window.location.href.includes('.net/ca')) {
    ...
    } else if (window.location.href.includes('.net/fl')) {
    ...
    } else if (window.location.href.includes('.net/tx')) {
    ...
    } else if (window.location.href.includes('.net/va')) {
      ...
      document.querySelector('.plan_slider .splide__list li.splide__slide:last-child').remove();
    } else if (window.location.href.includes('.net/baltimore')) {
...
var pageList = [
  ...
  "https://oncourse-portal-qa.ohscloud.net/lasvegas/",
  "https://oncourse-portal-qa.ohscloud.net/nyc/",
  "https://oncourse-portal-qa.ohscloud.net/phoenix/",
  "https://oncourse-portal-qa.ohscloud.net/philadelphia/",
  "https://oncourse-portal-qa.ohscloud.net/detroit/",
  "https://oncourse-portal-qa.ohscloud.net/orlando/",
  "https://oncourse-portal-qa.ohscloud.net/tx/",
  "https://oncourse-portal-qa.ohscloud.net/wilmington/",
  "https://oncourse-portal-qa.ohscloud.net/yonkers/",
  "https://oncourse-portal-qa.ohscloud.net/baltimore/",
  "https://oncourse-portal-qa.ohscloud.net/fortwayne/",
  "https://oncourse-portal-qa.ohscloud.net/fl/"
];

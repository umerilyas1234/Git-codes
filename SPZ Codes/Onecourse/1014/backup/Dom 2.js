...
function spz1014Test() {
  if (!document.querySelector('body').classList.contains('spz_1014_v1', "v2")) {
...
var pageList = [
  ...
  "https://oncourse-portal-qa.ohscloud.net/cart",
  "https://oncourse-portal-qa.ohscloud.net/cart/payment"
];
...
function runCodeBasedOnUrl() {
  ...
  if (currentPage === "https://oncourse-portal-qa.ohscloud.net/") {
...
const observer = new MutationObserver(() => {
  ...
  if (currentPage === previousUrl) {
    ...
    var isHomepage = currentPage === "https://oncourse-portal-qa.ohscloud.net/";
    ...
    if (selectorElement) {
      ...
      // If element exists but code hasn't run, run it
      if ((isHomepage || isInList) && !hasSpzClass) {

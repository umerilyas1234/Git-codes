      ...
      <div class="auto_container">
        <div class="our_valuesInner">
          ...
          <div class="value_bottom">
            <figure><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/oncourse/1014/3_badges.webp"
                alt="badges"></figure>
                    ...
                    <div class="partner_data">
                      <picture>
                        <source srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/oncourse/1014/logo_10.webp"
                          type="image/webp" media="(max-width: 767px)">
                        <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/oncourse/1014/logo_7.webp"
                          alt="Delaware">
                      </picture>
                    </div>
                  </li>
                    ...
                    <div class="partner_data">
                      <picture>
                        <source srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/oncourse/1014/logo_9.webp"
                          type="image/webp" media="(max-width: 767px)">
                        <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/oncourse/1014/logo_8.webp"
              ...
              <ul class="splide__list">
                <li class="splide__slide">
                  <div class="testimonial_data">
                    <div class="testimonial_dataTop">
                      <span><img
                          src="https://res.cloudinary.com/spiralyze/image/upload/v1760978025/oncourse/1014/atomquote.svg"
                          alt="quote"></span>
                ...
                <li class="splide__slide">
                  <div class="testimonial_data v2">
                    <div class="testimonial_dataTop">
                      <span><img
                          src="https://res.cloudinary.com/spiralyze/image/upload/v1760978034/oncourse/1014/atomquote_1.svg"
                          alt="quote"></span>
...
const selector1014 = '.awr-home__render-components';
function waitForElement(selector1014, timeout = 10000) {
  return new Promise((resolve, reject) => {
    const element = document.querySelector(selector1014);
    if (element) {
      resolve(element);
      return;
    }
    ...
    setTimeout(() => {
      clearInterval(interval);
      reject(new Error(`Element not found: ${selector1014}`));
    }, timeout);
  });
}

...
const stickyFooterContent = {
  trustImage: [
    {
      breakPoint: 992,
      url: "https://res.cloudinary.com/spiralyze/image/upload/f_auto/Code_Templates_assets/Sticky_Footer/product_placeholder_v4_desktop.png",
    },
  ], 
  alt: "Trust logos",
  heading: "Headline copy here. No more than 1 line of text.",
  subHeading: "Subheadline copy here. No more than 1 line of text.",
  CTAs: [
  	{
	  	ctaText: "Primary CTA",
	  	ctaURL: "http://......",
    ...
    <div class="spz-footer-container">
    	<div class="spz-trust-logos-wrap">
            ...
            <div class="spz-copy-wrap">
	    		...
	    		<div class="spz-copy-subheading">${stickyFooterContent.subHeading}</div>
	    	</div>
    	</div>

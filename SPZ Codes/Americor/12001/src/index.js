...
function loadTestCode12001() {
  if (!document.querySelector("body").classList.contains("spz_12001")) {
    ...
    var formInterval = setInterval(() => {
      if (document.querySelectorAll(".americor-form").length > 0) {
        clearInterval(formInterval);
        // insert form
        var heroForm = document.querySelector(".americor-form");
        document
        ...
        //  insert footer text
        var formNote = document.querySelector(".form-disclosure");
        document
        ...
        var submitBtn = document.querySelector(
          ".americor-form .form-group~button[type='submit']"
        );
